    ...
    <div class="container">
        ...
        <form action="{{ route('lessons.update', $lessons->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" name="name" value="{{ $lessons->name }}" class="form-control">
                @if ($errors->any())
            ...
            <div class="form-group">
                <label>Content</label>
                <textarea name="content" value="" class="form-control">{{ $lessons->content }}</textarea>
                @if ($errors->any())
            ...
            <div class="form-group">
                <label>Video</label>
                <input type="file" name="video" value="{{ $lessons->video }}" class="form-control-file">
                @if ($errors->any())
            ...
            <div class="form-group">
                ...
                <select name="categories[]" multiple="multiple" size="3" class="form-control"
